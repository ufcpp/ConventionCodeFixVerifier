...
namespace TestHelper
{
    public abstract class ConventionCodeFixVerifier : CodeFixVerifier
    {
        ...
        protected void VerifyCSharpDiagnosticByConvention([CallerMemberName]string testName = null)
        {
        ...
        protected void VerifyCSharpCodeFixByConvention([CallerMemberName]string testName = null)
        {
            var sourcePath = Path.Combine(DataSourcePath, testName, "Source.cs");
            var source = File.ReadAllText(sourcePath);
            source = HeaderSource + source + FooterSource;
